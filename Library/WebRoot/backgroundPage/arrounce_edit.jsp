	...
	<div class="row-fluid">
		<div class="span10">
			<form id ="newsForm" action="${pageContext.request.contextPath}/AnnouncementServlet" method="post">
                     ...
                     <textarea rows="10" id="Content" name="Content" style="margin-left: 0px; margin-right: 0px; width: 865px;">${acc.a_content }</textarea>
                     <input type="hidden" name="method" value="update"/><br>
                     <input type="hidden" name="aid" value="${param.a_id }"/><br>
